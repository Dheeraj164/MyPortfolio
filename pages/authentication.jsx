...
//       <p className="text-8xl z-10 relative flex  top-[20%]">Hello</p>
...
const Authentication = () => {
  return (
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        <div className="absolute inset-0 w-full h-[30vh] lg:h-[40vh] bg-black/80 z-10" />
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white z-10 p-2">
          <h2 className="py-2 text-white">Authentication App</h2>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid grid-cols-5 gap-8 pt-8">
        ...
        <aside className="col-span-4 lg:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4">
          <div className="p-2">
            <p className="text-center text-2xl font-bold pb-2">Technologies</p>
            <div className="grid grid-cols-2 lg:grid-cols-1">
              <div className="text-gray-600 text-xl py-2 flex items-center">
                <RiRadioButtonFill className="mr-3 flex-shrink-0" />
                <span>React Native</span>
              </div>

              <div className="text-gray-600 text-xl py-2 flex items-center">
                <RiRadioButtonFill className="mr-3 flex-shrink-0" />
                <span>Native Wind</span>
              </div>
              ...
              <div className="text-gray-600 text-xl py-2 flex items-center">
                <RiRadioButtonFill className="mr-3 flex-shrink-0" />
                <span>React Native AsyncStorage</span>
              </div>
        ...
        <Link href="/#project" className="col-span-5 lg:col-span-5">
          <div className="inline-flex items-center gap-2 text-indigo-600 hover:underline">
            <RiArrowDropLeftLine className="mt-1.5" />
            <span>Back</span>
          </div>
        </Link>
      </div>
